...
/*
 * Forked from https://github.com/DusanKasan/parsemail
 *
...
func decodeEmbeddedFile(part *multipart.Part) (ef EmbeddedFile, err error) {
	...
	ef.ContentDisposition = part.Header.Get("Content-Disposition")
...
func decodeAttachment(part *multipart.Part) (at Attachment, err error) {
	...
	at.ContentDisposition = part.Header.Get("Content-Disposition")
